...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@alfred/elgato": path.join(root, "packages/elgato/src/index.ts"),
      ...
      "@alfred/provider-apple-stt": path.join(root, "packages/provider-apple-stt/src/index.ts"),
      "@alfred/provider-openai": path.join(root, "packages/provider-openai/src/index.ts"),
      "@alfred/provider-xai": path.join(root, "packages/provider-xai/src/index.ts"),
