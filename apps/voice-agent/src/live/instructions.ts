...
export async function buildLiveBackendInstructions(brain: AlfredBrain): Promise<string> {
  ...
  return [
    ...
    "Tools: search_memory, remember_memory, update_reminder, list_due_reminders, get_weather_forecast, control_studio_lights, play_daily_briefing, decline_briefing_offer, show_expression, delegate_task.",
